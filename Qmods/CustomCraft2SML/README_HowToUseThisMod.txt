How to use CustomCraft2SML (Version 1.11.0)
 -------------------------------------------- 
...
ModifiedRecipes: Modify an existing crafting recipe. 
 ...
 -------------------------------------------- 
ModifiedFoods: Modify the food and water values of an existing food item.
...
Remember: For now, each file can only contain one type of entry. The valid entry types are: MovedRecipes, CustomSizes, CustomBioFuels, CustomFoods, CustomFabricators, CustomCraftingTabs, ModifiedRecipes, ModifiedFoods, AddedRecipes, AliasRecipe.
